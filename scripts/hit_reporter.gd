...
func report_hit(proj_damage: int, proj_break_damage: int, proj_knockback: Vector2, stun: float) -> void:
	# simply report the hit up to the boss
	bodyChief.being_hit(proj_damage, proj_break_damage, proj_knockback, stun)
