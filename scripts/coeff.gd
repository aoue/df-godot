...
var speed: int = 6500  # speed at which units move across the map
...
"""Movement Constants"""
var boost_speed_set: float = 8000.0  # boosting sets your speed to this value
...
"""AI Parameters"""
var attack_delay_per_cotargeter: int = 500  # the number of ticks a unit must wait before attacking a unit its fellows are cotargeting.
