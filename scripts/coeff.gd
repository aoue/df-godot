...
var speed: int = 7000  # speed at which units move across the map
...
var move_stun_duration: float = 0.5  # base duration of movement lockout on being hit
...
var time_before_boost_permitted: int = 200  # how long (ms) a unit must be in a given intention before it may boost.
var time_between_intention_update: int = 2000  # in ms. temp for now.
var attack_permission_timer: int = 4000  # lockout time on giving permission for another unit to attack a unit (in milliseconds)
